...
public class AddingTwoPowers {
	public static void main(String[] args) {
		BigInteger base1 = new BigInteger("123");
		BigInteger power1 = new BigInteger("123");
		BigInteger base2 = new BigInteger("123");
		BigInteger power2 = new BigInteger("123");
